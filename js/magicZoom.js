    ...
    $.fn.magicZoom = function(options) {
        ...
        var plugin = {
            ...
            styleElements: function() {
                ...
                if ($("#magiczoom-wrapper").length >= 1 || $("#magiczoom-zoom").length >= 1) {
                ...
                // wrap our plugin
                image.wrap("<div id='magiczoom-wrapper'></div>");
                wrapper = $("#magiczoom-wrapper");
                ...
                wrapper.append("<div id='magiczoom-zoom'></div>");
                magiczoomZoom = $("#magiczoom-zoom");
